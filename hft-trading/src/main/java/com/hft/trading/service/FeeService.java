...
/**
 * Fee calculation and deduction service. Supports Maker/Taker fee model with
...
public class FeeService {
  ...
  /**
   * Get tiered fee configuration for a symbol and user tier. Uses cache for
   * performance.
   */
  ...
  /**
   * Get fee configuration for a symbol and account. Looks up user tier and
   * returns appropriate
   * tiered config.
   */
  ...
  /**
   * Get fee configuration for a symbol (legacy method). Uses cache for
   * performance.
   *
   ...
   *
   * @deprecated Use calculateFeeScaled(accountId, symbol, tradeValueScaled,
   *             isMaker) instead
   */
  @Deprecated
