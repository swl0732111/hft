...
/**
 * Chronicle Queue implementation for trade events. Separate queue from orders for better isolation
 * and performance.
 */
@Slf4j
@Component
public class ChronicleTradeQueue {
  ...
  /**
   * Append trade event to queue. Zero-allocation, ~200ns latency.
   *
